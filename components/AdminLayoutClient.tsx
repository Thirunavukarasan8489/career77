...
export default function AdminLayoutClient({ children, userEmail }: AdminLayoutClientProps) {
  ...
  // Don't render layout frame on admin login page
  ...
  const handleLogout = async () => {
    ...
    showToast("Super Admin logged out successfully.");
  };

  const adminEmail = userEmail || "admin@career77.com";
  ...
  const getPageTitle = () => {
    ...
    if (pathname.startsWith("/admin/jobs")) return "Jobs Moderation";
    ...
    if (pathname.startsWith("/admin/cms")) return "CMS Editor";
        ...
        <aside className="hidden lg:flex w-64 flex-col fixed inset-y-0 z-30 bg-white border-r border-slate-200/80 shadow-[1px_0_10px_rgba(0,0,0,0.02)]">
          ...
          <div className="p-6 border-b border-slate-100 flex items-center gap-3">
            ...
            <div className="flex flex-col min-w-0">
              ...
              <span className="text-[11px] font-semibold text-purple-600 tracking-wide mt-1">
                Super Admin
              </span>
            </div>
          </div>
              ...
              <div className="p-5 border-b border-slate-100 flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] font-bold text-purple-600">Super Admin</p>
                  </div>
                </div>
                <button
                  onClick={() => setIsMobileDrawerOpen(false)}
        ...
        <div className="flex-1 lg:pl-64 flex flex-col min-w-0">
          ...
          <header className="sticky top-0 z-20 bg-white/90 backdrop-blur-md border-b border-slate-200/80 px-4 sm:px-8 py-4 flex items-center justify-between gap-4">
            ...
            <div className="hidden sm:flex flex-1 max-w-md mx-4">
              <div className="relative w-full">
                ...
                <input
                  ...
                  placeholder="Search users, companies, jobs, or tickets..."
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <button
                onClick={() => showToast("Platform alerts: 2 pending verifications, 1 ticket.")}
              ...
              >
                ...
                <span className="absolute top-1.5 right-1.5 w-2.5 h-2.5 rounded-full bg-purple-600 ring-2 ring-white animate-pulse" />
              </button>

              {/* System Help Button */}
              <button
                onClick={() => showToast("Super Admin controls & API documentation loaded.")}
              ...
              <div className="flex items-center gap-3 pl-2 border-l border-slate-200/80">
                <div className="hidden sm:flex flex-col text-right">
                  <span className="font-bold text-xs text-slate-900 leading-tight">Super Admin</span>
                  <span className="text-[11px] font-medium text-purple-600">Platform Admin</span>
                </div>
                <div
                  className="w-9 h-9 rounded-full bg-purple-600 text-white font-bold flex items-center justify-center text-sm ring-2 ring-white shadow-xs shrink-0 cursor-pointer hover:bg-purple-700 transition-colors"
                  onClick={handleLogout}
          ...
          {/* Viewport Content (NO FOOTER AT ALL) */}
